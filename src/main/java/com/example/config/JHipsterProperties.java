...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "BookService@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "BookService API";

        private String description = "BookService API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "BookService";
